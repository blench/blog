						...
						<table width="1000" style="BORDER-RIGHT:#cccccc 1px solid; BORDER-TOP:#cccccc 1px solid; BORDER-LEFT:#cccccc 1px solid; BORDER-BOTTOM:#cccccc 1px solid; BACKGROUND-COLOR:#f5f5f5"
							...
							<tr height="20">
								<td>
									&nbsp;&nbsp;&nbsp;标题：
									<div>
										&nbsp;&nbsp;&nbsp;<input type="text" name="article.title"  Width="600px" Style="inputcss" />
									</div>
								</td>
							</tr>
							<tr>
								<td>
									&nbsp;&nbsp;&nbsp;内容：
									<FCK:editor instanceName="article.content" basePath="/user/fckeditor" toolbarSet="myToolbar" height="200"></FCK:editor>
								</td>
							</tr>
							<tr height="20">
								<td>
