...
<body topmargin="0" leftmargin="0" bgcolor="#f3f3f3">
		...
		<form id="Form1" action="${pageContext.request.contextPath}/user/editBlogInfo.action" method="post">
					...
					<td valign="top">
						<table width="500" border="1" cellpadding="0" cellspacing="0" style="background-color:#FFFFFF;BORDER-RIGHT:#cccccc 1px solid; BORDER-TOP:#cccccc 1px solid; BORDER-LEFT:#cccccc 1px solid; BORDER-BOTTOM:#cccccc 1px solid; BORDER-COLLAPSE:collapse">
							...
							<tr height="30">
								...
								<td><input name="blogInfo.blogtitle" type="text"/>*</td>
								<td width=><s:fielderror><s:param>blogInfo.blogtitle</s:param></s:fielderror></td>
							</tr>
							<tr height="30">
								<td align="right">个性签名</td>
								<td><input name="blogInfo.idiograph" type="text"/>*</td>
								<td width=><s:fielderror><s:param>blogInfo.idiograph</s:param></s:fielderror></td>
							</tr>
							<tr height="30">
